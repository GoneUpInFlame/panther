...
namespace panther {
    template<class T> class RandomCandidate : public NextCandidateDistribution<T> {
    public:
    ...
    template<class T> class Metropolis : public AcceptanceFunction<T> {
    public:
    ...
    template<class T> class StandartCooling : public CoolingSchedule<T> {
    public:
    ...
    template<class T> class StandartStoping : public StopingCriterion<T> {
    public:
